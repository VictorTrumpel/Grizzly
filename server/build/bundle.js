...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"ArtistController\": () => (/* binding */ ArtistController),\n/* harmony export */   \"artistController\": () => (/* binding */ artistController)\n/* harmony export */ });\n/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ \"tslib\");\n/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tslib__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jsonwebtoken */ \"jsonwebtoken\");\n/* harmony import */ var jsonwebtoken__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsonwebtoken__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _validation_artist_registration_registrationValid__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../validation/artist/registration/registrationValid */ \"./src/validation/artist/registration/registrationValid.ts\");\n/* harmony import */ var _methods_addArtistMethod__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./methods/addArtistMethod */ \"./src/controllers/artistController/methods/addArtistMethod.ts\");\n/* harmony import */ var _validation_artist_login_loginValid__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../validation/artist/login/loginValid */ \"./src/validation/artist/login/loginValid.ts\");\n/* harmony import */ var _methods_getArtistTokenMethod__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./methods/getArtistTokenMethod */ \"./src/controllers/artistController/methods/getArtistTokenMethod.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\nclass ArtistController {\r\n    constructor() {\r\n        this.addArtist = _methods_addArtistMethod__WEBPACK_IMPORTED_MODULE_3__.addArtistMethod;\r\n        this.getArtistToken = _methods_getArtistTokenMethod__WEBPACK_IMPORTED_MODULE_5__.getArtistTokenMethod;\r\n    }\r\n    registration(req, res, next) {\r\n        var _a;\r\n        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {\r\n            const userRegData = {\r\n                userAvatar: ((_a = req === null || req === void 0 ? void 0 : req.files) === null || _a === void 0 ? void 0 : _a.avatar) || null,\r\n                userEmail: req.body.email,\r\n                userPassword: req.body.password,\r\n                userNickname: req.body.nickname\r\n            };\r\n            (0,_validation_artist_registration_registrationValid__WEBPACK_IMPORTED_MODULE_2__.registrationValid)(next, userRegData, this.addArtist.bind(null, res));\r\n        });\r\n    }\r\n    login(req, res, next) {\r\n        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {\r\n            const userLoginData = {\r\n                userEmail: req.body.email,\r\n                userPassword: req.body.password\r\n            };\r\n            (0,_validation_artist_login_loginValid__WEBPACK_IMPORTED_MODULE_4__.loginValid)(next, userLoginData, this.getArtistToken.bind(null, res, next));\r\n        });\r\n    }\r\n    static GenerateUserJwt(id, email, role) {\r\n        return jsonwebtoken__WEBPACK_IMPORTED_MODULE_1___default().sign({ id, email, role }, \"cytradovechera29\" || 0, {\r\n            expiresIn: '24h'\r\n        });\r\n    }\r\n    auth(req, res, next) {\r\n        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {\r\n            const token = ArtistController.GenerateUserJwt(req.user.id, req.user.email, req.user.role);\r\n            return res.json(token);\r\n        });\r\n    }\r\n}\r\nconst artistController = new ArtistController();\r\n\n\n//# sourceURL=webpack://server/./src/controllers/artistController/artistController.ts?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './userRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './typeRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './deviceRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/* harmony import */ var _artistRouter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./artistRouter */ \"./src/routes/artistRouter.ts\");\n/* harmony import */ var _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../middleware/authMiddleware */ \"./src/middleware/authMiddleware.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\nconst router = (0,express__WEBPACK_IMPORTED_MODULE_0__.Router)();\r\nrouter.use('/type', _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__.authMiddleware, Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './typeRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\r\nrouter.use('/device', _middleware_authMiddleware__WEBPACK_IMPORTED_MODULE_3__.authMiddleware, Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './deviceRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\r\nrouter.use('/user', Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './userRouter'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));\r\nrouter.use('/artist', _artistRouter__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (router);\r\n\n\n//# sourceURL=webpack://server/./src/routes/index.ts?");
